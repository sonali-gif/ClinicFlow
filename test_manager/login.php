...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($valid) {
        $_SESSION['test_manager_id'] = $test_manager['id'] ?? 1;
        $_SESSION['test_manager_name'] = $test_manager['full_name'] ?? 'Test Manager';
        header("Location: dashboard.php");
        exit();
    } else {
...
<head>
    ...
    <style>
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 4px rgba(0, 114, 195, 0.1);
        }
        .btn-info {
            padding: 12px;
            border-radius: 12px;
...
<div class="login-card">
    <div class="login-header">
        ...
        <h3>Lab Portal</h3>
        <p>Login to Laboratory Management</p>
    </div>
    <div class="login-body">
        ...
        <form method="POST">
            ...
            <button type="submit" class="btn btn-info w-100 shadow-sm">Sign in to Lab</button>
        </form>
